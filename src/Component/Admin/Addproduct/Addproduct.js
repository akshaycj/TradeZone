...
import { Input, Select, Upload, Icon, Modal, Button, Tag, Tooltip, Spin } from "antd";
...
this.setState({uid:e})
  ...
  render() {
    ...
    return (
      <div>
      {this.state.spin == true ? <Spin/>:
      <div>
        <h1>Add Product</h1>
        <div className="add-main">
        <Select placeholder="select User" onChange={this.userSelect} style={{width: "100%", margin: 10 }}>
